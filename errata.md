...
| p. 102     | ソースコード                  |                                                 | codes フォルダ以下 [chap06/code_6_4.cpp](https://github.com/drken1215/book_algorithm_solution/blob/master/codes/chap06/code_6_4.cpp) のように変更 | 元のコードでは 27 行目の `int val = *iter;` において、iter = b.end() である可能性があり、エラーが起こり得ました | 3 刷で対応 |
